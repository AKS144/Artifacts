      ...
      <div class="card-body">
        <form action="{{ route('artifacts.store') }}" method="POST">
          ...
          <div class="row mb-6">
            ...
            <div class="col-sm-12">
              <input type="text" class="form-control" id="basic-default-name" name="name" placeholder="Artifact Name" />
            </div>
          </div><br />
          <div class="row mb-6">
            <label class="col-sm-4 col-form-label" for="basic-default-company">Donor/Owner</label>
            <div class="col-sm-12">
              <input type="text" class="form-control" id="basic-default-company" name="donor" placeholder="Donor/Owner" />
            </div>
          </div><br />
          ...
          <div class="row mb-6">
            ...
            <div class="col-sm-12">
              <input type="text" id="basic-default-phone" class="form-control phone-mask" name="qrcode" placeholder="Qr Number" aria-label="" aria-describedby="basic-default-phone" />
            </div>
          </div><br />
          <div class="row mb-6">
            <label class="col-sm-4 col-form-label" for="basic-default-phone">Product S.No</label>
            <div class="col-sm-12">
              <input type="text" id="basic-default-phone" class="form-control phone-mask" name="artifacts_sno" placeholder="S.No" aria-label="" aria-describedby="basic-default-phone" />
            </div>
          </div><br />
          <div class="row mb-6">
            <label class="col-sm-4 col-form-label" for="basic-default-message">Description</label>
            <div class="col-sm-12">
              <textarea id="basic-default-message" class="form-control" name="description" placeholder="Description" aria-label="Hi, Do you have a moment to talk Joe?" aria-describedby="basic-icon-default-message2"></textarea>
            </div>
          </div><br />
