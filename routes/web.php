...
Route::post('/form/artifacts/store',$controller_path . '\form_layouts\ArtifactsController@store')->name('artifacts.store');
Route::get('/form/artifacts/show/{id}',$controller_path . '\form_layouts\ArtifactsController@show')->name('artifacts.show');
